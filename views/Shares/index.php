    ...
    <div class="row">
        ...
        <div class="col-md-3 ">
            ...
            <div class="list-group">
                <a href="<?php echo ROOT_URL?>/shares"  class="list-group-item list-group-item-action active">All Categories</a>
                <?php foreach($viewmodel[1] as $cat) : ?>
                
                <a href="<?php echo ROOT_URL.'/shares/posts/'.$cat['id'] ?>"  class="list-group-item list-group-item-action"><?php echo $cat["name"] ?></a>
                <?php endforeach; ?>
            </div>
        </div>
        <div class="col-md-9">
            ...
            <div class="card" style="width:100%;">
                <img  class="card-img-top" src="<?php echo "./".$item["image"] ?>" alt="Card image">
                <div class="card-body">
